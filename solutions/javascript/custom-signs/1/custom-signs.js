...
export function costOf(sign, currency) {
  const basePrice = 20; // Giá cơ bản
  const pricePerChar = 2; // Giá mỗi ký tự
  const totalCost = basePrice + (sign.length * pricePerChar);

  // format 2 chữ số thập phân và trả về kết quả
